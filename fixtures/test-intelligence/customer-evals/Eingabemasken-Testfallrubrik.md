...
| 3. Pflicht-Techniken nach ISO 29119 je Maskentyp | `src/test-intelligence/policy-profile.ts` |
...
| 5. Harte Ablehnungskriterien zusaetzlich zur Mutterrubrik | `src/test-intelligence/eingabemasken-fixtures.ts` |
| 6. Pflege | `src/test-intelligence/eingabemasken-fixtures.ts` und `fixtures/test-intelligence/customer-evals/SAMPLE-PLAN.md` |
