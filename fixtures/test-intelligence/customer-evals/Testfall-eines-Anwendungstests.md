...
| --- | --- |
| 1. Zielbild | `README.md` und `COMPLIANCE.md` |
| 2. Mindestformat je Testfall | `src/test-intelligence/customer-markdown-renderer.ts` |
| 3. Umfang und Schnitt | `fixtures/test-intelligence/customer-evals/SAMPLE-PLAN.md` |
| 4. Inhaltliche Abdeckung | `src/test-intelligence/policy-profile.ts` und `src/test-intelligence/test-data-oracle.ts` |
| 5. Banken- und Versicherungsleitplanken Europa 2026 | `COMPLIANCE.md` und `THREAT_MODEL.md` |
| 6. Umgang mit unklaren Anforderungen | `src/test-intelligence/test-data-oracle.ts` |
| 7. Qualitaetskriterien und Scoring | `src/test-intelligence/customer-markdown-renderer.ts` |
| 8. Harte Ablehnungskriterien | `src/test-intelligence/customer-markdown-renderer.ts` |
| 9. Gute Formulierungen | `src/test-intelligence/customer-markdown-renderer.ts` |
| 10. Grounding Stand 2026 | `COMPLIANCE.md`, `SECURITY.md`, `THREAT_MODEL.md` |
