...
The initial six locales are DE-DE, DE-AT, DE-CH, EN-IE, FR-FR, and IT-IT.
The corpus also covers PL-PL (Polish), ES-ES (Spanish), NL-NL (Dutch), CS-CZ
(Czech), and HU-HU (Hungarian).
