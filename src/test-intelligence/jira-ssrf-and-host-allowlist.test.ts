...
void test("jira-ssrf-and-host-allowlist: rejected hosts fail before network access", () => {
  const rejected = [
...
void test("jira-ssrf-and-host-allowlist: auth-specific public hosts are accepted only in their expected shape", () => {
  assert.doesNotThrow(() =>
