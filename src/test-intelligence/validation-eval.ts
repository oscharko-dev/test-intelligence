...
import type { ExportPipelineArtifacts } from "@oscharko-dev/ti-production-runner";
import type { ValidationPipelineArtifacts } from "@oscharko-dev/ti-production-runner";
import { canonicalJson } from "@oscharko-dev/ti-security";
import { detectDuplicateTestCases } from "@oscharko-dev/ti-core-engine";
...
export const evaluateWave1Validation = (
  ...
  const thresholds =
    input.thresholds ?? WAVE1_VALIDATION_DEFAULT_EVAL_THRESHOLDS;
