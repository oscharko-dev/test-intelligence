...
void test("baseline-eval: registers a canonical eval-baseline file for each archetype", async () => {
...
void test("baseline-eval: checked-in eval baselines match the deterministic builder", async () => {
...
void test("baseline-eval: every checked-in artifact is canonical JSON", async () => {
  for (const archetypeId of BASELINE_ARCHETYPE_FIXTURE_IDS) {
...
void test("baseline-eval: write helper is byte-stable on the second write", async () => {
...
void test("baseline-eval: persisted metric surface stays fully populated", async () => {
...
void test("baseline-eval: diff against an identical artifact reports zero deltas", async () => {
...
void test("baseline-eval: diff surfaces scalar-metric, traceability, and contract drift", async () => {
...
void test("baseline-eval: diff throws when archetype ids do not match", async () => {
  const baseline = await readBaselineArchetypeEvalArtifact(
    "baseline-simple-form",
  );
