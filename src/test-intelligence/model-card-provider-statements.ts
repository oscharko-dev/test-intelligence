  ...
  Object.freeze([
    Object.freeze({
      ...
      statement: Object.freeze([
        ...
        "Test Intelligence consumes Azure AI Foundry deployments read-only via the configured EU region tenant. The exact training-data lineage of each underlying model is documented by the model provider; see the per-provider entries below for the upstream statements.",
      ]),
    ...
    Object.freeze({
      ...
      statement: Object.freeze([
        ...
        "Mistral does not use prompts sent to its API (or to enterprise resellers such as Azure AI Foundry) to train its foundation models without explicit customer opt-in. The Test Intelligence deployment does not opt into training-data contributions.",
      ]),
      appliesToDeployments: Object.freeze([
        "mistral-large-3",
        "mistral-document-ai-2512",
    ...
    Object.freeze({
      ...
      statement: Object.freeze([
        ...
        "When the model is hosted on Azure AI Foundry the inference traffic does not flow back to Meta. Test Intelligence consumes the deployment read-only.",
      ]),
