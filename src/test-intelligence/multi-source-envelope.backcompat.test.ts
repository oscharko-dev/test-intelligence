...
void test("Wave-1-style single-source IR has no sourceEnvelope field", () => {
...
void test("single-source Wave-1 IR is canonically deterministic across two derivations", () => {
...
void test("attaching a sourceEnvelope to the IR is additive: existing fields stay byte-stable", () => {
...
void test("identical envelopes produce identical aggregate hashes (replay-cache stability)", () => {
  const sources = [
    {
      sourceId: "src.0",
...
void test("legacySourceFromMultiSourceEnvelope projects to the existing source shape", () => {
