...
import { DEFAULT_FINOPS_BUDGET_ENVELOPE } from "@oscharko-dev/ti-model-gateway";
import {
...
const FIXTURES_DIR = join(new URL(".", import.meta.url).pathname, "../../packages/core-engine/src/fixtures");
