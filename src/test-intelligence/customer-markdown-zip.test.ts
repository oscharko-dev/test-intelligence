...
void test("buildCustomerMarkdownZipBundle includes all five logical entries", () => {
...
void test("buildCustomerMarkdownZipBundle is byte-stable for identical inputs", () => {
  const a = buildCustomerMarkdownZipBundle(fixedBundle());
  const b = buildCustomerMarkdownZipBundle(fixedBundle());
  assert.equal(a.equals(b), true);
});

void test("buildCustomerMarkdownZipBundle omits manifest entry when not provided", () => {
...
void test("buildCustomerMarkdownZipBundle output unzips with the system unzip CLI", async () => {
  const zip = buildCustomerMarkdownZipBundle(fixedBundle());
...
void test("readCustomerMarkdownZipInputs returns not_found when job dir is missing", async () => {
...
void test("readCustomerMarkdownZipInputs rejects path-traversal jobIds", async () => {
...
void test("readCustomerMarkdownZipInputs assembles a bundle from on-disk artifacts", async () => {
