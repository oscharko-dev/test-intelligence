...
import { transitionReviewState } from "@oscharko-dev/ti-review";
...
void test("policy-bypass: risk-tag downgrade (regulated→low) — policy raises risk_tag_downgrade_detected (Issue #1412)", () => {
...
void test("policy-bypass: risk-tag downgrade detection respects screen scoping for PII (Issue #1412)", () => {
...
void test("policy-bypass: risk-tag downgrade detection can be disabled via profile flag (Issue #1412)", () => {
...
void test("policy-bypass: missing trace → case is blocked with missing_trace", () => {
...
void test("policy-bypass: fake review state — approving a blocked case returns 409", async () => {
...
void test("policy-bypass: direct export with case missing from validationReport → review_state_inconsistent", () => {
...
void test("policy-bypass: spoofed fromState — attempting to approve a blocked case returns 409 (state machine)", async () => {
...
void test("policy-bypass: transferred state cannot be rolled back to approved (state machine)", () => {
...
void test("policy-bypass: transferred state cannot be rolled back via review_started either", () => {
...
void test("policy-bypass: visual_sidecar_blocked propagates to export refusal even when cases look approved", () => {
...
void test("policy-bypass: visual sidecar blocked through validation pipeline also reaches export", () => {
