...
void test("jira-paste-html-xss: pasted markdown and plain text executable payloads are refused", async () => {
  const fixture = await readFile(
    new URL("../../packages/core-engine/src/fixtures/adversarial-jira-html-xss.paste.txt", import.meta.url),
    "utf8",
  );
  for (const body of [
    fixture,
...
void test("jira-paste-html-xss: safe markdown paste still ingests without executable content", () => {
