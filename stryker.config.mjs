 ...
 *   - `src/server/request-security.ts` (~293 LOC, request-security middleware)
 *
...
const config = {
  ...
  commandRunner: {
    command:
      "tsx --test src/error-sanitization.test.ts src/server/request-security.test.ts",
  },
  reporters: ["progress", "clear-text", "html"],
  htmlReporter: { fileName: "reports/mutation/mutation.html" },
  jsonReporter: { fileName: "reports/mutation/mutation.json" },
  mutate: ["src/error-sanitization.ts", "src/server/request-security.ts"],
