...
import { createDefaultTmsHttpClient } from "@oscharko-dev/ti-integrations";
...
test("xray-adapter: end-to-end push against vendored mock writes round-trip ids", async () => {
  ...
  try {
    ...
    const env = {
      TEST_INTELLIGENCE_TMS_XRAY_BASE_URL: mock.baseUrl,
      TEST_INTELLIGENCE_TMS_XRAY_TOKEN: "tok-xyz",
    };
