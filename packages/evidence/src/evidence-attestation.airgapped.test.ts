...
void test("evidence-attestation [airgap]: unsigned mode does not import network primitives", async () => {
...
void test("evidence-attestation [airgap]: unsigned signing+persist+verify works with disabled fetch", async (t) => {
