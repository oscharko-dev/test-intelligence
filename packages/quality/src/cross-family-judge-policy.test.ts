...
void test("isJudgeModelFamily refuses unknown families", () => {
...
void test("isJudgeModelRegion refuses unknown regions", () => {
  assert.equal(isJudgeModelRegion("eu"), true);
  assert.equal(isJudgeModelRegion("apac"), false);
});

void test("assertCrossFamilyInvariant accepts a panel of distinct families", () => {
  const panel = [
...
void test("assertCrossFamilyInvariant refuses two roles backed by the same family", () => {
  const panel = [
    baseBinding("logic_judge", "anthropic", "accept"),
...
void test("assertCrossFamilyInvariant honors the allowSharedFamily override", () => {
  const panel = [
    baseBinding("logic_judge", "anthropic", "accept"),
    baseBinding("faithfulness_judge", "anthropic", "repair"),
  ];
...
void test("assertEuResidency accepts EU-region bindings", () => {
  const panel = [baseBinding("logic_judge", "anthropic", "accept", "eu")];
  assert.doesNotThrow(() => assertEuResidency(panel));
});

void test("assertEuResidency refuses any non-EU region binding", () => {
  const panel = [
...
void test("classifyDecision: unanimous_accept", () => {
  assert.equal(
    classifyDecision([
      baseBinding("logic_judge", "anthropic", "accept"),
      baseBinding("faithfulness_judge", "openai", "accept"),
...
void test("classifyDecision: unanimous_reject", () => {
  assert.equal(
    classifyDecision([
...
void test("classifyDecision: 2:1 majority is majority_decision", () => {
  assert.equal(
    classifyDecision([
      baseBinding("logic_judge", "anthropic", "accept"),
      baseBinding("faithfulness_judge", "openai", "accept"),
...
void test("classifyDecision: 1:1:1 is split_decision", () => {
  assert.equal(
    classifyDecision([
      baseBinding("logic_judge", "anthropic", "accept"),
...
void test("resolveQuorumVerdict: tie containing repair downgrades to repair", () => {
  assert.equal(
    resolveQuorumVerdict([
      baseBinding("logic_judge", "anthropic", "accept"),
      baseBinding("faithfulness_judge", "openai", "repair"),
...
void test("resolveQuorumVerdict: tie of accept and reject only downgrades to repair", () => {
  assert.equal(
    resolveQuorumVerdict([
      baseBinding("logic_judge", "anthropic", "accept"),
      baseBinding("faithfulness_judge", "openai", "reject"),
...
void test("assessCrossFamilyPanel escalates 1:1:1 splits to human_review_required", () => {
  const panel = [
    baseBinding("logic_judge", "anthropic", "accept"),
    baseBinding("faithfulness_judge", "openai", "repair"),
    baseBinding("a11y_judge", "google", "reject"),
...
void test("assessCrossFamilyPanel escalates lone-dissenter from most-trusted family", () => {
  const panel = [
    baseBinding("logic_judge", "anthropic", "reject"),
    baseBinding("faithfulness_judge", "openai", "accept"),
    baseBinding("a11y_judge", "google", "accept"),
...
void test("assessCrossFamilyPanel does not escalate a 2:1 majority when dissenter is not most trusted", () => {
  const panel = [
    baseBinding("logic_judge", "anthropic", "accept"),
    baseBinding("faithfulness_judge", "openai", "accept"),
    baseBinding("a11y_judge", "google", "reject"),
...
void test("assessCrossFamilyPanel is unanimous-friendly: no escalation, zero rates", () => {
  const panel = [
    baseBinding("logic_judge", "anthropic", "accept"),
    baseBinding("faithfulness_judge", "openai", "accept"),
    baseBinding("a11y_judge", "google", "accept"),
...
void test("assessCrossFamilyPanel propagates the EU residency refusal", () => {
  const panel = [
    baseBinding("logic_judge", "anthropic", "accept", "eu"),
    baseBinding("faithfulness_judge", "openai", "accept", "us"),
...
void test("assessCrossFamilyPanel refuses an empty panel", () => {
  assert.throws(
    () => assessCrossFamilyPanel([]),
...
void test("assessCrossFamilyPanel refuses an unknown mostTrustedFamily option", () => {
  const panel = [
    baseBinding("logic_judge", "anthropic", "accept"),
    baseBinding("faithfulness_judge", "openai", "accept"),
  ];
