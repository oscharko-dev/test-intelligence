...
void test("voteGeneratedTestCaseSamples applies 2-of-3 majority and preserves clean targets", () => {
...
void test("voteGeneratedTestCaseSamples routes unresolved disagreement to human review", () => {
  const sampleA = makeList([
...
void test("voteGeneratedTestCaseSamples can surface weak consensus toward cross-family arbitration", () => {
  const sampleA = makeList([
...
void test("writeSelfConsistencyReport persists the canonical report artifact", async () => {
