...
void test("buildLibraryCoverageReport sorts deterministically and rolls counts", () => {
...
void test("buildLibraryCoverageReport rejects malformed inputs", () => {
  assert.throws(
    () =>
      buildLibraryCoverageReport({
        releaseId: "",
...
void test("isLibraryCoverageReport rejects schema drift and bad counts", () => {
...
void test("writeLibraryCoverageReport persists canonical JSON byte-stably", async () => {
...
void test("library-coverage-report: golden byte-identity for the canonical example", () => {
  const artifact = buildLibraryCoverageReport({
    releaseId: "figma-ds@2026.05.0",
    generatedAt: "2026-05-04T08:00:00.000Z",
    primitives: [baseEntry()],
  ...
  const golden =
    '{"contractVersion":"1.39.0","counts":{"deprecated":0,"implemented":1,"stub":0,"total":1,"unimplemented":0},' +
