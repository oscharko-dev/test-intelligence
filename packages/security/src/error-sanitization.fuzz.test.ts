...
void test("fuzz: sanitizeErrorMessage redacts secret-bearing fragments in root errors and causes", () => {
  fc.assert(
    fc.property(
      secretFragmentArb,
      fc.boolean(),
...
void test("fuzz: sanitizeErrorMessage redacts Luhn-valid PAN-like sequences in root errors and causes", () => {
  fc.assert(
...
void test("fuzz: error chain redactor strips POSIX home directory prefixes regardless of username shape", () => {
  fc.assert(
...
void test("fuzz: error chain redactor strips Windows home directory prefixes regardless of username shape", () => {
  fc.assert(
...
void test("fuzz: error chain redactor strips absolute node_modules paths", () => {
  fc.assert(
