...
void test("label-anchored: redacts repoToken=value", () => {
...
void test("label-anchored: redacts Authorization: Bearer ...", () => {
...
void test("label-anchored: redacts JSON token field", () => {
...
void test("bare JWT (eyJ... . ... . ...) is redacted in free text", () => {
  const jwt =
...
void test("bare GitHub PAT (ghp_...) is redacted", () => {
...
void test("bare Figma personal access token (figd_...) is redacted", () => {
...
void test("bare Atlassian PAT (ATATT3...) is redacted", () => {
...
void test("bare AWS access-key id (AKIA*) is redacted", () => {
...
void test("bare Slack bot token (xoxb-...) is redacted", () => {
...
void test("bare-token redaction does NOT trigger on short identifiers", () => {
...
void test("bare-token redaction is composable with label-anchored redaction in one message", () => {
  const jwt =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9" +
    ".eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4ifQ" +
    ".SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";
...
void test("redactor is idempotent: applying twice equals applying once", () => {
...
void test("bare JWT preceded by 'prefix-' (no label, hyphen boundary) is redacted", () => {
  const jwt =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9" +
    ".eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4ifQ" +
    ".SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";
...
void test("bare JWT inside a colon-delimited shape (no label) is redacted", () => {
  const jwt =
...
void test("bare JWT directly concatenated to alnum prefix without separator is NOT redacted (intentional)", () => {
