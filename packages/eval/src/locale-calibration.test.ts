...
import type { BusinessTestIntentScreen } from "@oscharko-dev/ti-contracts";
...
void test("locale-calibration: isSupportedLocale returns true for all six codes", () => {
...
void test("locale-calibration: isSupportedLocale returns false for unknown codes", () => {
...
void test("locale-calibration: SUPPORTED_LOCALES covers all eleven locales (Issue #2117 + #2188)", () => {
  assert.deepEqual([...SUPPORTED_LOCALES].sort(), [
    "CS-CZ",
    "DE-AT",
    "DE-CH",
    "DE-DE",
...
void test("locale-calibration: LOCALE_CALIBRATION_FALLBACK_KEY is not a SupportedLocale", () => {
...
void test("locale-calibration: exact SupportedLocale in screenLocale is returned as-is", () => {
  for (const locale of SUPPORTED_LOCALES) {
    assert.equal(
...
void test("locale-calibration: 2-letter primary tag 'de' promotes to DE-DE", () => {
  assert.equal(deriveLocaleFromScreen({ screenLocale: "de" }), "DE-DE");
});

void test("locale-calibration: 2-letter primary tag 'fr' promotes to FR-FR", () => {
  assert.equal(deriveLocaleFromScreen({ screenLocale: "fr" }), "FR-FR");
});

void test("locale-calibration: 2-letter primary tag 'it' promotes to IT-IT", () => {
  assert.equal(deriveLocaleFromScreen({ screenLocale: "it" }), "IT-IT");
});

void test("locale-calibration: 2-letter primary tag 'en' promotes to EN-IE (EU banking default)", () => {
  assert.equal(deriveLocaleFromScreen({ screenLocale: "en" }), "EN-IE");
});

// Issue #2188 — extended locale primary-tag promotions.
void test("locale-calibration: 2-letter primary tag 'pl' promotes to PL-PL", () => {
  assert.equal(deriveLocaleFromScreen({ screenLocale: "pl" }), "PL-PL");
});

void test("locale-calibration: 2-letter primary tag 'es' promotes to ES-ES", () => {
  assert.equal(deriveLocaleFromScreen({ screenLocale: "es" }), "ES-ES");
});

void test("locale-calibration: 2-letter primary tag 'nl' promotes to NL-NL", () => {
  assert.equal(deriveLocaleFromScreen({ screenLocale: "nl" }), "NL-NL");
});

void test("locale-calibration: 2-letter primary tag 'cs' promotes to CS-CZ", () => {
  assert.equal(deriveLocaleFromScreen({ screenLocale: "cs" }), "CS-CZ");
});

void test("locale-calibration: 2-letter primary tag 'hu' promotes to HU-HU", () => {
...
void test("locale-calibration: IBAN prefix AT maps to DE-AT", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix CH maps to DE-CH", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix DE maps to DE-DE", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix FR maps to FR-FR", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix IE maps to EN-IE", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix IT maps to IT-IT", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix PL maps to PL-PL", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix ES maps to ES-ES", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix NL maps to NL-NL", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix CZ maps to CS-CZ", () => {
  assert.equal(
...
void test("locale-calibration: IBAN prefix HU maps to HU-HU", () => {
  assert.equal(
...
void test("locale-calibration: Sozialversicherungsnummer keyword maps to DE-AT", () => {
  assert.equal(
    deriveLocaleFromScreen({
      validationStrings: ["Sozialversicherungsnummer"],
    }),
    "DE-AT",
  );
});

void test("locale-calibration: UID-Nummer ATU keyword maps to DE-AT", () => {
  assert.equal(
...
void test("locale-calibration: AHV-Nummer keyword maps to DE-CH", () => {
  assert.equal(
...
void test("locale-calibration: Champ obligatoire keyword maps to FR-FR", () => {
  assert.equal(
...
void test("locale-calibration: Numéro de TVA FR keyword maps to FR-FR", () => {
  assert.equal(
...
void test("locale-calibration: Codice Fiscale keyword maps to IT-IT", () => {
  assert.equal(
...
void test("locale-calibration: Partita IVA IT keyword maps to IT-IT", () => {
  assert.equal(
...
void test("locale-calibration: Campo obbligatorio keyword maps to IT-IT", () => {
  assert.equal(
...
void test("locale-calibration: Eircode keyword maps to EN-IE", () => {
  assert.equal(
...
void test("locale-calibration: PPS Number keyword maps to EN-IE", () => {
  assert.equal(
...
void test("locale-calibration: Required field keyword maps to EN-IE", () => {
  assert.equal(
...
void test("locale-calibration: Pflichtfeld alone maps to DE-DE", () => {
  assert.equal(
...
void test("locale-calibration: Pole wymagane keyword maps to PL-PL", () => {
  assert.equal(
...
void test("locale-calibration: PESEL keyword maps to PL-PL", () => {
  assert.equal(deriveLocaleFromScreen({ fieldLabels: ["PESEL"] }), "PL-PL");
});

void test("locale-calibration: Campo obligatorio keyword maps to ES-ES", () => {
  assert.equal(
...
void test("locale-calibration: DNI keyword maps to ES-ES", () => {
  assert.equal(deriveLocaleFromScreen({ fieldLabels: ["DNI"] }), "ES-ES");
});

void test("locale-calibration: Campo obbligatorio (IT) still maps to IT-IT, not ES-ES", () => {
...
void test("locale-calibration: Verplicht veld keyword maps to NL-NL", () => {
  assert.equal(
...
void test("locale-calibration: BSN keyword maps to NL-NL", () => {
  assert.equal(deriveLocaleFromScreen({ fieldLabels: ["BSN"] }), "NL-NL");
});

void test("locale-calibration: Povinné pole keyword maps to CS-CZ", () => {
  assert.equal(
...
void test("locale-calibration: Rodné číslo keyword maps to CS-CZ", () => {
  assert.equal(
...
void test("locale-calibration: Kötelező mező keyword maps to HU-HU", () => {
  assert.equal(
...
void test("locale-calibration: Adószám keyword maps to HU-HU", () => {
...
void test("locale-calibration: returns undefined for empty input", () => {
  assert.equal(deriveLocaleFromScreen({}), undefined);
});

void test("locale-calibration: returns undefined for unrecognised screenLocale", () => {
...
void test("locale-calibration: returns undefined for non-matching keywords", () => {
  assert.equal(
    deriveLocaleFromScreen({
      validationStrings: ["required", "max length 100"],
    }),
    undefined,
  );
});
...
void test("locale-calibration: deriveLocaleFromBusinessTestIntentScreen reads screen.locale", () => {
...
void test("locale-calibration: deriveLocaleFromBusinessTestIntentScreen falls back to supplementary", () => {
  const screen: BusinessTestIntentScreen = {
    screenId: "s1",
    screenName: "Test",
    trace: { nodeId: "s1" },
...
void test("locale-calibration: deriveLocaleFromBusinessTestIntentScreen returns undefined when nothing matches", () => {
  const screen: BusinessTestIntentScreen = {
    screenId: "s1",
    screenName: "Test",
    trace: { nodeId: "s1" },
...
void test("locale-calibration: fixture DE-AT resolves to DE-AT via keyword heuristic", async () => {
  const raw = JSON.parse(
    await readFile(join(FIXTURES_DIR, "DE-AT.figma.json"), "utf8"),
  ) as {
...
void test("locale-calibration: fixture DE-CH resolves to DE-CH via keyword heuristic", async () => {
  const raw = JSON.parse(
    await readFile(join(FIXTURES_DIR, "DE-CH.figma.json"), "utf8"),
  ) as {
    nodes: Array<{ validations?: string[]; nodeName?: string }>;
  };
  const validations = raw.nodes.flatMap((n) => n.validations ?? []);
...
void test("locale-calibration: fixture DE-DE resolves to DE-DE via direct locale tag", async () => {
  const raw = JSON.parse(
    await readFile(join(FIXTURES_DIR, "DE-DE.figma.json"), "utf8"),
  ) as {
...
void test("locale-calibration: fixture EN-IE resolves to EN-IE via keyword heuristic", async () => {
  const raw = JSON.parse(
    await readFile(join(FIXTURES_DIR, "EN-IE.figma.json"), "utf8"),
  ) as {
    nodes: Array<{ validations?: string[]; nodeName?: string }>;
  };
  const validations = raw.nodes.flatMap((n) => n.validations ?? []);
...
void test("locale-calibration: fixture FR-FR resolves to FR-FR via direct locale tag", async () => {
  const raw = JSON.parse(
    await readFile(join(FIXTURES_DIR, "FR-FR.figma.json"), "utf8"),
  ) as {
    locale: SupportedLocale;
  };
...
void test("locale-calibration: fixture IT-IT resolves to IT-IT via direct locale tag", async () => {
  const raw = JSON.parse(
    await readFile(join(FIXTURES_DIR, "IT-IT.figma.json"), "utf8"),
  ) as {
    locale: SupportedLocale;
  };
...
for (const [expected, filename] of KEYWORD_FIXTURES) {
  void test(`locale-calibration: fixture ${expected} resolves to ${expected} via keyword heuristic`, async () => {
    const raw = JSON.parse(
      await readFile(join(FIXTURES_DIR, filename), "utf8"),
    ) as {
      nodes: Array<{ validations?: string[]; nodeName?: string }>;
    };
    const validations = raw.nodes.flatMap((n) => n.validations ?? []);
