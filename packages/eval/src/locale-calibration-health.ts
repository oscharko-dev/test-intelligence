...
const LOCALE_CALIBRATION_FIXTURE_ABSOLUTE_ROOT = join(
...
export interface LocaleCalibrationHealthReport {
  readonly schemaVersion: typeof LOCALE_CALIBRATION_HEALTH_REPORT_SCHEMA_VERSION;
...
const isPlattCurveArtifact = (value: unknown): value is PlattCurveArtifact => {
...
export const loadLocaleCalibrationArtifacts = async (
  fixtureRoot: string = LOCALE_CALIBRATION_FIXTURE_ABSOLUTE_ROOT,
...
export class LocaleCalibrationHealthError extends Error {
  readonly code: typeof G13_LOCALE_CALIBRATION_HEALTHY =
