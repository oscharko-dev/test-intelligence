...
void test("property: identical envelopes always produce identical plan hash", () => {
  fc.assert(
...
void test("property: adding a second source changes the plan hash", () => {
  fc.assert(
...
void test("property: custom_markdown-only envelope always fails with primary_source_required", () => {
  fc.assert(
    fc.property(arbSourceId, (seed) => {
...
void test("property: jira_rest-only plans always have visualSidecarRequirement=not_applicable", () => {
  fc.assert(
    fc.property(arbSourceId, (seed) => {
...
void test("property: figma-primary plans always have visualSidecarRequirement=optional", () => {
  fc.assert(
    fc.property(arbSourceId, (seed) => {
      const ref: TestIntentSourceRef = {
...
void test("property: rawJiraResponsePersisted and rawPasteBytesPersisted are always false", () => {
  fc.assert(
    fc.property(arbSourceId, arbSourceId, (seed1, seed2) => {
      fc.pre(seed1 !== seed2);
...
void test("property: sourceMixPlanHash is always a 64-char lowercase hex string", () => {
