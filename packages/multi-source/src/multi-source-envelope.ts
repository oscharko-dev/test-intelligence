...
const REFUSAL_DETAIL: Record<MultiSourceModeGateRefusalCode, string> = {
  test_intelligence_disabled:
    "TEST_INTELLIGENCE_ENABLED env var or testIntelligence.enabled startup option is not enabled.",
  multi_source_env_disabled:
    "TEST_INTELLIGENCE_MULTISOURCE_ENABLED env var is not enabled.",
...
/**
 * Resolve the multi-source env gate.
 */
