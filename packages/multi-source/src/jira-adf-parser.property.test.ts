...
void test("ADF parser property: parse(doc) is byte-stable across re-runs", () => {
  fc.assert(
...
void test("ADF parser property: every successful parse strips disallowed mention/inlineCard/media URIs", () => {
...
void test("ADF parser property: unknown node types always reject", () => {
  fc.assert(
    fc.property(
      fc
