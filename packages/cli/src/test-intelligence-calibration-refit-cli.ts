/**
 * `test-intelligence calibration-refit` sub-command
 * (Issue #2182).
 *
 * Drives the self-improving judge-calibration loop from the CLI.
 *
 * Usage:
 *   test-intelligence calibration-refit
 *     --locale <code>
 *     --risk-class <id>
...
export const TEST_INTELLIGENCE_CALIBRATION_REFIT_HELP = `test-intelligence calibration-refit - self-improving judge-calibration loop with hard rollback safety (Issue #2182)
