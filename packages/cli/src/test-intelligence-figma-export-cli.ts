/**
 * `test-intelligence figma-export` sub-command (Issue #2187).
 *
 ...
 * via `test-intelligence run --figma-payload <path>`.
 *
...
const HELP_TEXT = `\ntest-intelligence figma-export — sovereign-cloud Figma payload exporter (Issue #2187)

Usage:
  test-intelligence figma-export --figma-url <url> --output <path> [--figma-token <token>] [--timeout-ms <ms>]
