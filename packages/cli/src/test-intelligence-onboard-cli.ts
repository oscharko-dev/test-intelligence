/**
 * `test-intelligence onboard` sub-command (Issue #2185, W8-3).
 *
...
import { runTenantOnboarding, runTenantOnboardingDoctor, TenantOnboardingValidationError, type TenantOnboardingDoctorResult, type TenantOnboardingInput, type TenantOnboardingResult } from "@oscharko-dev/ti-tenant";
...
test-intelligence onboard — self-service customer onboarding (Issue #2185)
...
Usage:
  ...
  test-intelligence onboard --doctor \\
    --tenant-id <id> --output-root <dir> \\
    [--environment-id <id>] [--project-id <id>]
