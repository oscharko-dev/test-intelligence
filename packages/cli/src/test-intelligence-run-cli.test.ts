/**
 * Unit tests for the `test-intelligence run` flag parser and dispatcher.
 * The CLI's actual `runTestIntelligenceCommand` orchestration is covered
 * by injection-seam tests below; the end-to-end command path is exercised
 * by `cli.contract.test.ts`.
 */
...
const issue1993TopologyPreflightSupported = (() => {
  try {
    const opts = parseIssue1993TopologyRunArgs(
      ...
      {
        TEST_INTELLIGENCE_REQUIRE_MULTI_AGENT_TOPOLOGY: "1",
      },
    );
...
const issue1993RiskRankerPlumbingSupported = (() => {
  try {
    const opts = parseIssue1993TopologyRunArgs(
      ...
      {
        TEST_INTELLIGENCE_RISK_RANKER_DEPLOYMENT: "mistral-large-3",
      },
    );
...
const buildIssue1993RunResult = (
  ...
  ({
    ...
    blocked: false,
    judgeConsensus:
      {} as unknown as RunFigmaToQcTestCasesResult["judgeConsensus"],
    runQuality: {} as unknown as RunFigmaToQcTestCasesResult["runQuality"],
...
void test("parseTestIntelligenceRunArgs: requires exactly one source", () => {
  assert.throws(
...
void test("parseTestIntelligenceRunArgs: env defaults flow into options when flags absent", () => {
...
void test("parseTestIntelligenceRunArgs: allow-policy-blocked defaults to false", () => {
  const options = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc/foo", "--output", "/tmp/x"],
    {},
  );
...
void test("parseTestIntelligenceRunArgs: TEST_INTELLIGENCE_ALLOW_POLICY_BLOCKED enables policy bypass", () => {
  const options = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc/foo", "--output", "/tmp/x"],
    {
      TEST_INTELLIGENCE_ALLOW_POLICY_BLOCKED: "1",
    },
  );
  assert.equal(options.allowPolicyBlocked, true);
});

void test("parseTestIntelligenceRunArgs: --allow-policy-blocked sets allowPolicyBlocked", () => {
  const options = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc/foo",
...
void test("parseTestIntelligenceRunArgs: TEST_INTELLIGENCE_ALLOW_POLICY_BLOCKED can disable the bypass", () => {
  const options = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc/foo", "--output", "/tmp/x"],
    {
...
void test("parseTestIntelligenceRunArgs: --mode default is deterministic_llm", () => {
  const opts = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc/foo", "--output", "/tmp/x"],
    {},
  );
...
void test("parseTestIntelligenceRunArgs: rejects unknown flags", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: rejects unknown --mode value", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: empty value for required string flags fails", () => {
  for (const flag of [
    "--figma-url",
    "--output",
    "--model-endpoint",
...
void test("parseTestIntelligenceRunArgs: --no-visual-sidecar sets noVisualSidecar", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: --enable-visual-sidecar sets enableVisualSidecar", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: env override enables visual sidecar", () => {
  const opts = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc", "--output", "/tmp/x"],
    { TEST_INTELLIGENCE_ENABLE_VISUAL_SIDECAR: "1" },
  );
  assert.equal(opts.enableVisualSidecar, true);
  assert.equal(opts.noVisualSidecar, false);
});

void test("parseTestIntelligenceRunArgs: --enable-visual-sidecar conflicts with --no-visual-sidecar", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: --logic-judge-deployment captures the cross-model judge deployment (Issue #1932)", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: TEST_INTELLIGENCE_LOGIC_JUDGE_DEPLOYMENT env var hydrates the option (Issue #1932)", () => {
  const opts = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc", "--output", "/tmp/x"],
    {
...
void test("parseTestIntelligenceRunArgs: --logic-judge-deployment overrides the env default (Issue #1932)", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: --logic-judge-deployment rejects empty value (Issue #1932)", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: TEST_INTELLIGENCE_COVERAGE_PLANNER_DEPLOYMENT env var hydrates the option (Issue #1934)", () => {
  const opts = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc", "--output", "/tmp/x"],
    {
...
void test("parseTestIntelligenceRunArgs: --coverage-planner-deployment overrides the env default (Issue #1934)", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: visual and a11y deployment flags override env defaults (Issue #1996)", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
    ...
    ],
    {
      ...
      TEST_INTELLIGENCE_VISUAL_FALLBACK_DEPLOYMENT: "stale-fallback",
      TEST_INTELLIGENCE_A11Y_JUDGE_DEPLOYMENT: "stale-a11y",
    },
  );
...
void test("parseTestIntelligenceRunArgs: --require-multi-agent-topology and env TEST_INTELLIGENCE_REQUIRE_MULTI_AGENT_TOPOLOGY=1 hydrate strict mode (Issue #1993)", (t) => {
...
void test("parseTestIntelligenceRunArgs: risk-ranker env and flag hydrate topology planning when present (Issue #1993)", (t) => {
...
void test("parseTestIntelligenceRunArgs: --finops-budget captures path", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceDoctorArgs: env defaults flow into doctor options", () => {
  const options = parseTestIntelligenceDoctorArgs([], {
    ...
    TEST_INTELLIGENCE_A11Y_JUDGE_DEPLOYMENT: "phi-4-multimodal-instruct",
  });
...
void test("parseTestIntelligenceDoctorArgs: visual sidecar defaults stay aligned with the production runner", () => {
  const options = parseTestIntelligenceDoctorArgs([], {
    TEST_INTELLIGENCE_TESTCASE_MODEL_DEPLOYMENT: "mistral-large-3",
  });
  assert.equal(options.visualPrimaryDeployment, "llama-4-maverick-vision");
...
void test("parseTestIntelligenceDoctorArgs: CLI overrides doctor deployment defaults", () => {
  const options = parseTestIntelligenceDoctorArgs(
    [
      "--model-deployment",
      "mistral-large-3",
...
void test("runTestIntelligenceDoctorCommand: intended topology exits 0 with only ok statuses", async () => {
  ...
  const exitCode = await runTestIntelligenceDoctorCommand(
    ...
    sink,
    {
      env: {
        ...
        TEST_INTELLIGENCE_A11Y_JUDGE_DEPLOYMENT: "phi-4-multimodal-instruct",
        TEST_INTELLIGENCE_MODEL_ENDPOINT: "https://aoai.example/openai/v1",
        TEST_INTELLIGENCE_LLM_API_KEY: "secret-key",
      },
    },
  );
...
void test("runTestIntelligenceDoctorCommand: bad topology flags all affected roles and exits non-zero on invalid contracts", async () => {
  ...
  assert.match(
    output,
    /TEST_INTELLIGENCE_VISUAL_PRIMARY_DEPLOYMENT=llama-4-maverick-vision/u,
  );
});
...
void test("parseTestIntelligenceRunArgs: harness defaults are off/standard/undefined", () => {
  const opts = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc", "--output", "/tmp/x"],
    {},
  );
...
void test("parseTestIntelligenceRunArgs: --harness-mode accepts shadow_eval and enforced", () => {
...
void test("parseTestIntelligenceRunArgs: --harness-mode rejects unknown value", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: --harness-test-depth accepts standard and exhaustive", () => {
...
void test("parseTestIntelligenceRunArgs: --harness-test-depth rejects unknown value", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: --harness-role-step-id captures non-empty id", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: --harness-role-step-id rejects empty/whitespace", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: --harness-max-repair-iterations captures a non-negative integer", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: --harness-max-repair-iterations rejects non-integers and negatives", () => {
...
void test("parseTestIntelligenceRunArgs: --max-figma-payload-bytes is undefined when omitted (soft default)", () => {
  const opts = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc", "--output", "/tmp/x"],
    {},
  );
...
void test("parseTestIntelligenceRunArgs: --max-figma-payload-bytes accepts the soft default explicitly", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: --max-figma-payload-bytes accepts a 32 MiB tier-1 override (Issue #2172 Test-View-03)", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: --max-figma-payload-bytes accepts the 128 MiB ceiling exactly", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: --max-figma-payload-bytes rejects 1 byte above the ceiling", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: --max-figma-payload-bytes rejects negative / zero / non-integer / blank", () => {
...
void test("parseTestIntelligenceRunArgs: TEST_INTELLIGENCE_MAX_FIGMA_PAYLOAD_BYTES env override above ceiling is rejected", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        ["--figma-url", "https://figma.com/design/abc", "--output", "/tmp/x"],
        {
          TEST_INTELLIGENCE_MAX_FIGMA_PAYLOAD_BYTES: String(
...
void test("parseTestIntelligenceRunArgs: TEST_INTELLIGENCE_MAX_FIGMA_PAYLOAD_BYTES env override at ceiling is accepted", () => {
  const opts = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc", "--output", "/tmp/x"],
    {
      TEST_INTELLIGENCE_MAX_FIGMA_PAYLOAD_BYTES: String(
...
void test("parseTestIntelligenceRunArgs: --max-figma-payload-bytes overrides the env value", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
    ...
    {
      TEST_INTELLIGENCE_MAX_FIGMA_PAYLOAD_BYTES: "10485760",
    },
  );
...
void test("runTestIntelligenceCommand: missing TEST_INTELLIGENCE_ENABLED gate -> exit 1", async () => {
  const { sink, stdout, stderr } = collectingSink();
  ...
  assert.equal(exitCode, 1);
  assert.match(stderr.join(""), /TEST_INTELLIGENCE_ENABLED/u);
  assert.equal(stdout.join(""), "");
});

void test("runTestIntelligenceCommand: gate set to '0' is still off → exit 1", async () => {
  const { sink, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(baseOptions(), sink, {
    env: { TEST_INTELLIGENCE_ENABLED: "0" },
    now: () => 1700000000000,
  });
  assert.equal(exitCode, 1);
  assert.match(stderr.join(""), /TEST_INTELLIGENCE_ENABLED/u);
...
void test("runTestIntelligenceCommand: dry_run skips runner and exits 0", async () => {
  const { sink, stdout, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(baseOptions(), sink, {
    env: GATE_ON,
    now: () => 1700000000000,
...
void test("runTestIntelligenceCommand: dry_run output includes visual sidecar note", async () => {
  const { sink, stdout } = collectingSink();
...
void test("runTestIntelligenceCommand: dry_run output includes finops budget note when path given", async () => {
  const { sink, stdout } = collectingSink();
  await runTestIntelligenceCommand(
...
void test("runTestIntelligenceCommand: offline_eval routes to deterministic_llm", async () => {
  const { sink, stdout, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(
...
void test("runTestIntelligenceCommand: invalid finops-budget file → exit 1 with validation error", async () => {
  const { sink, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(
...
void test("runTestIntelligenceCommand: finops-budget file read error → exit 1", async () => {
  const { sink, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(
...
void test("runTestIntelligenceCommand: deterministic_llm blocked + allowPolicyBlocked=false → exit 3", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    figmaUrl: undefined,
    figmaJsonFile: "/tmp/figma.json",
...
void test("runTestIntelligenceCommand: deterministic_llm blocked + --allow-policy-blocked → exit 0", async () => {
  const { sink, stdout, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    figmaUrl: undefined,
    figmaJsonFile: "/tmp/figma.json",
...
void test("runTestIntelligenceCommand: computes default output from job id when --output omitted", async () => {
  const { sink, stdout } = collectingSink();
...
void test("runTestIntelligenceCommand: dry_run + harness-mode != off → exit 1 cross-flag error", async () => {
  const { sink, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(
...
void test("runTestIntelligenceCommand: deterministic_llm + harness-mode shadow_eval forwards harness config to runner and surfaces summary", async () => {
  const { sink, stdout, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    figmaUrl: undefined,
    figmaJsonFile: "/tmp/figma.json",
...
void test("runTestIntelligenceCommand: deterministic_llm + harness-mode off omits harness key from runner input", async () => {
...
void test("runTestIntelligenceCommand: enable-visual-sidecar builds and forwards runner bundle", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
    figmaUrl: undefined,
  ...
  const exitCode = await runTestIntelligenceCommand(options, sink, {
    ...
    buildLlmBundle: () => {
      ...
      return bundle as unknown as ReturnType<
        Required<TestIntelligenceRunRuntime>["buildLlmBundle"]
      >;
    },
    loadFigmaJsonFile: async () => ({
      fileKey: "abc",
...
void test("buildLiveVisualSidecarBundle: configured logic judge is included in the live bundle", () => {
  const bundle = buildLiveVisualSidecarBundle(
    {
      ...baseOptions(),
      modelEndpoint: "https://aoai.example/openai/v1",
...
void test("runTestIntelligenceCommand: strict preflight fails before runner when logic judge would reuse generator (Issue #1993)", async () => {
...
void test("runTestIntelligenceCommand: strict preflight rejects mistral-document-ai-2512 for visual primary (Issue #1993)", async () => {
  const { sink, stderr } = collectingSink();
  let runnerCalled = false;
  const exitCode = await runTestIntelligenceCommand(
    {
    ...
    sink,
    {
      env: {
        ...
        TEST_INTELLIGENCE_VISUAL_MODEL_ENDPOINT:
          "https://aoai.example/openai/vision",
        TEST_INTELLIGENCE_VISUAL_PRIMARY_DEPLOYMENT: "mistral-document-ai-2512",
        TEST_INTELLIGENCE_VISUAL_FALLBACK_DEPLOYMENT:
          "phi-4-multimodal-instruct",
      },
      runner: async () => {
...
void test("runTestIntelligenceCommand: strict preflight requires the full sidecar topology", async () => {
  const { sink, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(
    {
      ...baseOptions(),
...
void test("runTestIntelligenceCommand: strict preflight rejects deprecated deployment env aliases", async () => {
  const { sink, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(
    {
      ...baseOptions(),
    ...
    sink,
    {
      env: {
        ...
        TEST_INTELLIGENCE_VISUAL_MODEL_ENDPOINT:
          "https://aoai.example/openai/vision",
        TEST_INTELLIGENCE_AZURE_AI_FOUNDRY_VISUAL_PRIMARY_DEPLOYMENT:
          "legacy-primary",
      },
      loadFigmaJsonFile: async () => ({
        fileKey: "abc",
  ...
  assert.match(
    stderr.join(""),
    /uses deprecated env alias TEST_INTELLIGENCE_AZURE_AI_FOUNDRY_VISUAL_PRIMARY_DEPLOYMENT/u,
  );
});

void test("runTestIntelligenceCommand: enable-visual-sidecar fails closed when visual envs are missing", async () => {
  const { sink, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(
    {
      ...baseOptions(),
  ...
  assert.match(
    stderr.join(""),
    /requires TEST_INTELLIGENCE_VISUAL_MODEL_ENDPOINT, TEST_INTELLIGENCE_VISUAL_PRIMARY_DEPLOYMENT, TEST_INTELLIGENCE_VISUAL_FALLBACK_DEPLOYMENT/u,
  );
});

void test("runTestIntelligenceCommand: legacy behavior stays unchanged when strict topology mode is absent (Issue #1993)", async () => {
  const { sink, stdout, stderr } = collectingSink();
...
void test("runTestIntelligenceCommand: dry_run output mentions harness mode line", async () => {
  const { sink, stdout } = collectingSink();
...
void test("runTestIntelligenceCommand: strict preflight writes sanitized topology report and forwards risk ranker (Issue #1993)", async () => {
  const tmpDir = await mkdtemp(
    path.join(os.tmpdir(), "test-intelligence-ti-topology-"),
  );
  const { sink, stderr, stdout } = collectingSink();
      ...
      runner: async (input) => {
        ...
        return {
          ...
          judgeConsensus:
            {} as unknown as RunFigmaToQcTestCasesResult["judgeConsensus"],
          runQuality:
            {} as unknown as RunFigmaToQcTestCasesResult["runQuality"],
          finopsBudget:
            {} as unknown as RunFigmaToQcTestCasesResult["finopsBudget"],
...
void test("runTestIntelligenceCommand: legacy topology remains allowed when strict mode is absent", async () => {
  const { sink, stderr } = collectingSink();
  let runnerCalled = false;
  const exitCode = await runTestIntelligenceCommand(
    {
...
void test("parseTestIntelligenceRunArgs: --custom-context-markdown captures path", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc/foo",
...
void test("parseTestIntelligenceRunArgs: --custom-context-markdown rejects duplicate flag", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: captures customer eval, ICT ref, and timestamp output subdir", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc/foo",
  ...
  assert.equal(opts.ictRegisterRef, "test-intelligence-local-ict");
  assert.equal(opts.outputRunSubdir, "timestamp");
});

void test("parseTestIntelligenceRunArgs: --show-confidence enables customer markdown confidence output", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-json-file",
      "./fixture.json",
...
void test("parseTestIntelligenceRunArgs: customer eval and output subdir reject invalid values", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: TEST_INTELLIGENCE_ICT_REGISTER_REF hydrates default", () => {
  const opts = parseTestIntelligenceRunArgs(
    ["--figma-url", "https://figma.com/design/abc/foo"],
    { TEST_INTELLIGENCE_ICT_REGISTER_REF: " env-ref " },
  );
  assert.equal(opts.ictRegisterRef, "env-ref");
});

void test("parseTestIntelligenceRunArgs: --diversity-passes accepts 1, 2, and 3", () => {
...
void test("parseTestIntelligenceRunArgs: --diversity-passes rejects unsupported values", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("runTestIntelligenceCommand: dry_run with --custom-context-markdown reports loaded byte count", async () => {
  const { sink, stdout, stderr } = collectingSink();
...
void test("runTestIntelligenceCommand: dry_run with --customer-eval-markdown reports loaded byte count", async () => {
  ...
  const exitCode = await runTestIntelligenceCommand(
    {
      ...
      ictRegisterRef: "test-intelligence-local-ict",
  ...
  assert.match(out, /ict ref\s*: test-intelligence-local-ict/u);
  assert.match(out, /output subdir\s*: job-id/u);
});

void test("runTestIntelligenceCommand: --custom-context-markdown loader failure surfaces operator error and exits 1", async () => {
  const { sink, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(
    {
      ...baseOptions(),
...
void test("runTestIntelligenceCommand: --custom-context-markdown unexpected loader failure exits 1 with sanitised message", async () => {
  const { sink, stderr } = collectingSink();
  const exitCode = await runTestIntelligenceCommand(
    {
      ...baseOptions(),
...
void test("runTestIntelligenceCommand: deterministic_llm forwards customContextMarkdown to runner input", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    figmaUrl: undefined,
    figmaJsonFile: "/tmp/figma.json",
...
void test("runTestIntelligenceCommand: forwards customerEvalMarkdown and writes explicit output into timestamp run subdir", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
    figmaUrl: undefined,
...
void test("runTestIntelligenceCommand: deterministic_llm forwards diversityPasses to runner input", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
    figmaUrl: undefined,
...
void test("parseTestIntelligenceRunArgs: --customer-profile captures path", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: --customer-profile rejects empty value", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: --tenant-bundle captures path (Issue #2184)", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-url",
      "https://figma.com/design/abc",
...
void test("parseTestIntelligenceRunArgs: --tenant-bundle rejects empty value", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
...
void test("parseTestIntelligenceRunArgs: --tenant-bundle rejects duplicate flag", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("runTestIntelligenceCommand: dry_run with --tenant-bundle reports loaded byte count (Issue #2184)", async () => {
  const { sink, stdout } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
...
void test("runTestIntelligenceCommand: --tenant-bundle schema error surfaces all issues and exits 1 (Issue #2184)", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
...
void test("parseTestIntelligenceRunArgs: --customer-profile rejects duplicate flag", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("runTestIntelligenceCommand: dry_run with --customer-profile reports loaded byte count", async () => {
  const { sink, stdout } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
...
void test("runTestIntelligenceCommand: --customer-profile loader failure surfaces operator error and exits 1", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
...
void test("runTestIntelligenceCommand: --customer-profile oversize file is rejected with exit 1", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
...
void test("runTestIntelligenceCommand: --customer-profile schema error surfaces all issues and exits 1", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
...
void test("runTestIntelligenceCommand: deterministic_llm forwards customerProfile to runner input", async () => {
  const { sink, stderr } = collectingSink();
  const options: TestIntelligenceRunOptions = {
    ...baseOptions(),
    figmaUrl: undefined,
...
void test("parseTestIntelligenceRunArgs: coverageBaseline defaults to mode=check, undefined archetype, tenantId=default", () => {
  const opts = parseTestIntelligenceRunArgs(
...
void test("parseTestIntelligenceRunArgs: --coverage-baseline-archetype + tenant + runtime-root capture all knobs", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-json-file",
      "/tmp/x.json",
  ...
  assert.equal(
    opts.coverageBaseline!.runtimeRoot,
    "/var/lib/test-intelligence",
  );
  assert.equal(opts.coverageBaseline!.mode, "check");
});

void test("parseTestIntelligenceRunArgs: --coverage-baseline-update flips mode to update", () => {
  const opts = parseTestIntelligenceRunArgs(
    [
      "--figma-json-file",
      "/tmp/x.json",
...
void test("parseTestIntelligenceRunArgs: --coverage-baseline-update without --coverage-baseline-archetype is rejected", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
...
void test("parseTestIntelligenceRunArgs: --coverage-baseline-archetype rejects path-traversal segments", () => {
  assert.throws(
    () =>
      parseTestIntelligenceRunArgs(
        [
...
void test("parseTestIntelligenceRunArgs: TEST_INTELLIGENCE_TENANT_ID env hydrates the default tenant", () => {
  const opts = parseTestIntelligenceRunArgs(
    ["--figma-json-file", "/tmp/x.json"],
    { TEST_INTELLIGENCE_TENANT_ID: "tenant-from-env" },
  );
  assert.equal(opts.coverageBaseline!.tenantId, "tenant-from-env");
});

void test("parseTestIntelligenceVerifyProvenanceArgs: accepts explicit flag form", () => {
...
void test("parseTestIntelligenceAuditDossierArgs: reads run dir, output, and env signing key", () => {
  const parsed = parseTestIntelligenceAuditDossierArgs(
    ["--run-dir", "/tmp/run", "--output", "/tmp/out"],
    { TEST_INTELLIGENCE_AUDIT_SIGN_KEY: "/tmp/key.txt" },
  );
...
void test("parseTestIntelligenceAuditVerifyArgs: accepts positional bundle form", () => {
  const parsed = parseTestIntelligenceAuditVerifyArgs(["/tmp/bundle.json"]);
  assert.equal(parsed.bundle, "/tmp/bundle.json");
});

void test("runTestIntelligenceAuditVerifyCommand: returns 0 for the fixture bundle", async () => {
  const { sink, stdout, stderr } = collectingSink();
...
void test("runTestIntelligenceAuditVerifyCommand: invalid manifest shape returns exit 2 instead of throwing", async () => {
...
void test("runTestIntelligenceVerifyProvenanceCommand: returns 0 for a valid provenance bundle", async () => {
...
void test("runTestIntelligenceVerifyProvenanceCommand: returns non-zero on merkle mismatch", async () => {
...
void test("runTestIntelligenceVerifyProvenanceCommand: rejects artifact paths that escape the run directory", async () => {
...
void test("parseTestIntelligenceVerifySealArgs: positional bundle form", () => {
  const parsed = parseTestIntelligenceVerifySealArgs(["/tmp/run-2178"]);
  assert.equal(parsed.bundle, "/tmp/run-2178");
});

void test("parseTestIntelligenceVerifySealArgs: full flag form", () => {
...
void test("parseTestIntelligenceVerifySealArgs: rejects non-hex --expected-hmac", () => {
  assert.throws(
    () =>
      parseTestIntelligenceVerifySealArgs([
        "--bundle",
...
void test("parseTestIntelligenceVerifySealArgs: rejects unknown flag", () => {
  assert.throws(
    () =>
      parseTestIntelligenceVerifySealArgs([
        "--bundle",
...
void test("runTestIntelligenceVerifySealCommand: returns 1 for missing bundle path", async () => {
  const { sink, stderr } = collectingSink();
...
void test("runTestIntelligenceVerifySealCommand: returns 2 + report on tampered bundle dir", async () => {
...
void test("extractSealBundleArchive: refuses tar archives that contain symlinks", async () => {
