...
void test("buildWorkflowTopology derives stable ACT-* actions and transitions", () => {
...
void test("buildWorkflowTopology does not treat bare text elements as editable fields", () => {
...
void test("assertWorkflowTopologyInvariants rejects transitions with invalid guards", () => {
