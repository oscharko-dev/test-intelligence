...
export const ADVERSARIAL_CRITIC_RESPONSE_SCHEMA_NAME =
  "test-intelligence-adversarial-critic-v1" as const;
    ...
    findings: {
      ...
      items: {
        ...
        properties: {
          ...
          affectedValidationId: {
            type: "string",
            minLength: 1,
            maxLength: 160,
          },
          affectedNavigationId: {
            type: "string",
            minLength: 1,
            maxLength: 160,
          },
...
const buildPrompt = (
  ...
  return {
    playbook,
    systemPrompt: [
      "You are the adversarial critic for Test Intelligence.",
...
export const validateAdversarialCriticResponse = (
  ...
  const findingsRaw = (content as Record<string, unknown>)
    .findings as unknown[];
  ...
  const relativeRatioIncrease =
    baselineNegativeRatio === 0
      ? finalNegativeRatio > 0
        ...
        : 0
      : round6(
          (finalNegativeRatio - baselineNegativeRatio) / baselineNegativeRatio,
        );
