...
import type { LlmCircuitPersistentState } from "@oscharko-dev/ti-model-gateway";
import {
...
import { recordPersistentStoreRead } from "@oscharko-dev/ti-tenant";
...
export const PERSISTENT_CIRCUIT_BREAKER_STATE_SCHEMA_VERSION = "1.0.0" as const;
...
export const createPersistentReplayCache = (
  ...
  // deployments. Under `TEST_INTELLIGENCE_AIR_GAP_MODE=1`, a cache
...
const quarantineCorruptCacheEntry = async (path: string): Promise<void> => {
