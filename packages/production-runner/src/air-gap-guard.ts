...
export const AIR_GAP_MODE_ENV = "TEST_INTELLIGENCE_AIR_GAP_MODE" as const;
...
export const AIR_GAP_ALLOWED_HOSTS_ENV =
  "TEST_INTELLIGENCE_AIR_GAP_ALLOWED_HOSTS" as const;
...
export const createAirGapFetchGuard = (
  ...
  const guarded: typeof fetch = async (
    ...
    const allowList =
      explicitHosts.length > 0 ? explicitHosts : readAirGapAllowedHosts(env);
