export const LIVE_SMOKE_FLAG = "TEST_INTELLIGENCE_LIVE_SMOKE";

export const LIVE_SMOKE_SKIP_MESSAGE: string = `${LIVE_SMOKE_FLAG}=1 enables the operator-controlled live smoke test.`;

export const LIVE_LLM_API_KEY_ENV = "TEST_INTELLIGENCE_LLM_API_KEY";
...
export function formatMissingRequiredLiveEnvMessage(
