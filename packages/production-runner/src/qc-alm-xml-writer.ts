 ...
 * mapping preview. The schema is product-internal (not OpenText native)
 * but maps cleanly onto OpenText ALM concepts:
 *
 *   <workspace-alm-export
 *       xmlns="<ALM_EXPORT_XML_NAMESPACE>"
 *       schemaVersion="1.0.0"
 *       contractVersion="..."
 *       jobId="..."
 *       generatedAt="..."
 ...
 * their side; the namespaced root keeps the export contract stable across
 * OpenText product revisions.
 */
