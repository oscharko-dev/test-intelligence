...
void test("clean description returns ok-only outcome", () => {
...
void test("unexpected root properties are schema_invalid", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("schema_invalid is detected and is blocking", () => {
  const description = {
    screenId: "",
...
void test("unexpected region properties are schema_invalid", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("malformed ambiguity and piiFlags entries are schema_invalid", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("low region confidence raises low_confidence", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("possible_pii from sidecar piiFlags is blocking", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("uncorroborated broad sidecar piiFlags are downgraded", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("prompt-injection-like text is detected and blocking", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("conflicts with figma metadata when label disagrees without ambiguity", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("ambiguity note suppresses figma-conflict outcome", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("unknown screen id conflicts with figma metadata", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
...
void test("mock deployment without primary set marks fallback", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("current fallback deployment names are accepted and marked fallback", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("inline sidecar deployment alias normalizes to primary deployment", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("oversized sidecar deployment labels are schema_invalid", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
...
void test("records are sorted by screenId for stable serialization", () => {
  const report = validateVisualSidecar({
    jobId: "job-1",
    generatedAt: GENERATED_AT,
    visual: [
