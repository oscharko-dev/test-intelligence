...
void test("selectTestDesignHeuristics returns common baseline heuristics without source mix", () => {
...
void test("selectTestDesignHeuristics adds kind and prompt-section heuristics deterministically", () => {
...
void test("property: heuristic selection ignores source ordering for equivalent plans", () => {
  fc.assert(
...
void test("property: supporting-context heuristics appear only when prompt sections include custom context", () => {
  fc.assert(
