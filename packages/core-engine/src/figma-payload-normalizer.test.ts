...
void test("normalizeFigmaFileToIntentInput emits one screen per FRAME with bounding box", () => {
...
void test("normalizeFigmaFileToIntentInput skips invisible nodes", () => {
  const input: NormalizeFigmaInput = {
    fileKey: "ABC",
    document: node({
      id: "0:0",
...
void test("normalizeFigmaFileToIntentInput pulls text and button nodes inside a screen", () => {
  const input: NormalizeFigmaInput = {
    fileKey: "ABC",
    document: node({
      id: "0:0",
...
void test("normalizeFigmaFileToIntentInput suppresses decorative units and technical placeholders", () => {
  const input: NormalizeFigmaInput = {
    fileKey: "ABC",
    document: node({
      id: "0:0",
...
void test("normalizeFigmaFileToIntentInput emits no screens for an empty document", () => {
  const input: NormalizeFigmaInput = {
    fileKey: "ABC",
    document: node({
      id: "0:0",
...
void test("normalizeFigmaFileToIntentInput accepts a node-scoped FRAME directly as the document root", () => {
...
void test("normalizeFigmaFileToIntentInput is depth-bounded", () => {
