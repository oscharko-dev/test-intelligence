...
void test("reconciliation promotes existing Figma field to reconciled when visual agrees", () => {
...
void test("reconciliation emits ambiguity when visual label disagrees with Figma", () => {
  const visual: VisualScreenDescription[] = [
    {
      screenId: "s1",
      sidecarDeployment: "mock",
...
void test("reconciliation adds visual-only fields with provenance visual_sidecar", () => {
  const visual: VisualScreenDescription[] = [
    {
      screenId: "s1",
      sidecarDeployment: "mock",
...
void test("reconciliation contextualizes repeated choice fields from whole-screen visual text", () => {
...
void test("reconciliation contextualizes choice fields from sequential visual regions", () => {
  const intent = baseIntent();
  intent.detectedFields = [
    {
...
void test("reconciliation adds visual validation hints not already in Figma", () => {
  const visual: VisualScreenDescription[] = [
    {
      screenId: "s1",
      sidecarDeployment: "mock",
...
void test("reconciliation ignores non-actionable visual layout validation hints", () => {
  const visual: VisualScreenDescription[] = [
    {
      screenId: "s1",
      sidecarDeployment: "mock",
...
void test("reconciliation redacts visual-only PII before serializing the IR", () => {
  const visual: VisualScreenDescription[] = [
    {
      screenId: "s1",
      sidecarDeployment: "mock",
...
void test("reconciliation records visual sidecar piiFlags without original values", () => {
  const visual: VisualScreenDescription[] = [
    {
      screenId: "s1",
      sidecarDeployment: "mock",
