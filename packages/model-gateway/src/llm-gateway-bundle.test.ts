...
void test("bundle: rejects swapped or under-capable role clients", () => {
  assert.throws(
    () =>
      createMockLlmGatewayClientBundle({
        testGeneration: {
...
void test("bundle: optional logicJudge slot accepts a logic_judge client and rejects miswired roles (Issue #1932)", () => {
...
void test("bundle: optional testGenerationSecondary slot accepts a second text-only generator client (Issue #2125)", () => {
  const bundle = createMockLlmGatewayClientBundle({
    testGeneration: {
      role: "test_generation",
      deployment: "mistral-large-3",
...
void test("bundle: optional coveragePlanner slot accepts a coverage_planner client and rejects image-capable planners (Issue #1934)", () => {
  const bundle = createMockLlmGatewayClientBundle({
    testGeneration: {
      role: "test_generation",
      deployment: "mistral-large-3",
...
void test("bundle: probes all roles and persists per-role capability evidence", async () => {
...
void test("bundle: probes the logic_judge slot when wired (Issue #1932)", async () => {
...
void test("bundle: probes the a11y_judge slot when wired (Issue #1940)", async () => {
