...
// Bootstrap-period re-export. resolveTenantScopeSegments has moved to
// packages/tenant/src/tenant-scope-segments.ts (Issue #78). Callers of
// replay-cache.ts continue to import it from here until each module is
// extracted (issues #79+).
export { resolveTenantScopeSegments } from "@oscharko-dev/ti-tenant";
