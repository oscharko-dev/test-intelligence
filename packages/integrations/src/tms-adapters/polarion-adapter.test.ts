...
void test("polarion-adapter: connect probes projects endpoint", async () => {
...
void test("polarion-adapter: mapTestCase encodes data.id as first 12 hex chars", async () => {
  const fake = buildFakeHttp();
  fake.pushResponse({
    status: 200,
    headers: {},
...
void test("polarion-adapter: pushTestCase records pushed on 201", async () => {
  const fake = buildFakeHttp();
  fake.pushResponse({
    status: 200,
    headers: {},
...
void test("polarion-adapter: pushTestCase records skipped-dup on 200", async () => {
  const fake = buildFakeHttp();
  fake.pushResponse({
    status: 200,
    headers: {},
...
void test("polarion-adapter: pollSyncStatus returns attributes.status", async () => {
  const fake = buildFakeHttp();
  fake.pushResponse({
    status: 200,
    headers: {},
