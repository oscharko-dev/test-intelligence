...
void test("qc-provider-stub: every non-ALM provider refuses with provider_not_implemented", async () => {
...
void test("qc-provider-stub: folder resolution is simulated with canonical evidence", async () => {
...
void test("qc-provider-stub: provider_mismatch surfaces alongside provider_not_implemented", async () => {
...
void test("qc-provider-stub: validateProfile detects provider mismatch", () => {
  const stub = createDryRunStubAdapter({ provider: "xray" });
...
void test("qc-provider-stub: api_transfer mode throws QcAdapterModeNotImplementedError", async () => {
...
void test("qc-provider-stub: export_only mode throws QcAdapterModeNotImplementedError", async () => {
...
void test("qc-provider-stub: refuses to shadow opentext_alm", () => {
  assert.throws(
...
void test("qc-provider-stub: same input produces deterministic reportId", async () => {
...
void test("qc-provider-stub: custom idSource controls reportId shape", async () => {
...
void test("qc-provider-stub: provider_not_implemented exists on the contract refusal enum", () => {
  assert.ok(
