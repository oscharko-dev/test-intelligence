...
void test("qc-mapping-profile: valid profile yields ok=true with no errors", () => {
...
void test("qc-mapping-profile: missing required fields produce actionable diagnostics", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
...
void test("qc-mapping-profile: invalid target folder path rejected", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
...
void test("qc-mapping-profile: invalid path: trailing slash and empty segments", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
...
void test("qc-mapping-profile: invalid path: dot-only segments", () => {
...
void test("qc-mapping-profile: provider mismatch produces a single error", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
...
void test("qc-mapping-profile: credential-like requiredFields are rejected", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
...
void test("qc-mapping-profile: credential-like baseUrlAlias rejected", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
...
void test("qc-mapping-profile: duplicate requiredFields flagged", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
...
void test("qc-mapping-profile: unsupported testEntityType warns but does not block", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
...
void test("qc-mapping-profile: missing designStepMapping action+expected blocks", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
...
void test("qc-mapping-profile: profile id mismatch is a warning, not an error", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
  const result = validateQcMappingProfile({
    profile,
...
void test("qc-mapping-profile: ALL issues carry JSON-pointer paths and messages", () => {
  const profile = cloneOpenTextAlmDefaultMappingProfile();
