...
// Standalone has a single npm artifact (ADR-0006) and no template
// subprojects. Missing static targets fail closed in runGuard.
const STATIC_TARGETS = ["package.json", "pnpm-lock.yaml"];
