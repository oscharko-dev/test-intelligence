 ...
 * as a generated artifact. The card is kept in lock-step with the routing
 * policy, contract version, and domain-invariant catalog without committing
...
const main = async (): Promise<void> => {
  ...
  const dir = join(repoRoot, MODEL_CARD_OUTPUT_DIRNAME);
  const jsonPath = join(
    dir,
